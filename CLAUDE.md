...
|---|---|
| `herramientas/serie/` | **Los sketches y el banco de pruebas del puerto de servicio.** Ver la sección del DE-9. `tabla_fusibles_de9.jpg` es la primera foto del conector en su lugar, con la tabla de fusibles; `tabla_fusibles_de9.md` la lee, y anota que **faltan dos fusibles** |
